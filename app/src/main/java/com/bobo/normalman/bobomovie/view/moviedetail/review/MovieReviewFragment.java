...
public class MovieReviewFragment extends Fragment {
    ...
    private MovieReviewListAdapter adapter = null;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new MovieReviewListAdapter(new ArrayList<Review>(), true, new BaseListAdapter.LoadMoreListener() {
            @Override
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(KEY_REVIEWS,
                ModelUtil.toString(adapter.data, new TypeToken<List<Review>>() {
                }));
